...
JSValueProxyImp::JSValueProxyImp( KJS::ExecState *exec, int mid, const JSValueProxy *parent )
    : JSProxyImp(exec), id(mid), proxy(parent)
{
}

JSValueProxyImp::~JSValueProxyImp()
{
}

KJS::Value JSValueProxyImp::call( KJS::ExecState *exec, KJS::Object &self, const KJS::List &args )
{
    switch( id ) {
	case MethodTypeName:
	{
