...
namespace Gadget
{
    ...
    {
        enum { value = (::Gadget::Conversion<const volatile U*, const volatile T*>::exists &&
                        !::Gadget::Conversion<const volatile T*, const volatile void*>::sameType) };
    };
    ...
    struct SuperSubclassStrict
    {
        enum { value = (::Gadget::Conversion<const volatile U*, const volatile T*>::exists &&
                        !::Gadget::Conversion<const volatile T*, const volatile void*>::sameType &&
                        !::Gadget::Conversion<const volatile T*, const volatile U*>::sameType) };
    };
...
#define SUPERSUBCLASS(T, U) \
    ::Gadget::SuperSubclass<T,U>::value
...
#define SUPERSUBCLASS_STRICT(T, U) \
    ::Gadget::SuperSubclassStrict<T,U>::value
