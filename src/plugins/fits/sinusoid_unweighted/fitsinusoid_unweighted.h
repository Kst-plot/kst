...
#ifndef FITSINUSOIDUNWEIGHTEDPLUGIN_H
...
class FitSinusoidUnweightedSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  protected:
    FitSinusoidUnweightedSource(Kst::ObjectStore *store);
    ~FitSinusoidUnweightedSource();
