...
#ifndef FITSINUSOIDWEIGHTEDPLUGIN_H
#define FITSINUSOIDWEIGHTEDPLUGIN_H
...
class FitSinusoidWeightedSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  public:
    ...
    Kst::ScalarPtr scalarHarmonics() const;
  ...
  protected:
    FitSinusoidWeightedSource(Kst::ObjectStore *store);
