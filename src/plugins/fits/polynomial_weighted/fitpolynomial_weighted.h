...
#ifndef FITPOLYNOMIALWEIGHTEDPLUGIN_H
#define FITPOLYNOMIALWEIGHTEDPLUGIN_H
...
class FitPolynomialWeightedSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  protected:
    FitPolynomialWeightedSource(Kst::ObjectStore *store);
