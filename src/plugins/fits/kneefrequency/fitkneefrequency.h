...
class FitKneeFrequencySource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  public:
    ...
    Kst::ScalarPtr scalarMax() const;
    Kst::ScalarPtr scalarMin() const;
    Kst::ScalarPtr scalarWhiteNoise() const;
  ...
  protected:
    FitKneeFrequencySource(Kst::ObjectStore *store);
    ~FitKneeFrequencySource();
