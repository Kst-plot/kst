...
#ifndef NOISEADDITIONPLUGIN_H
#define NOISEADDITIONPLUGIN_H
...
class NoiseAdditionSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  public:
    ...
    Kst::ScalarPtr scalarSigma() const;
  ...
  protected:
    NoiseAdditionSource(Kst::ObjectStore *store);
    ~NoiseAdditionSource();
