...
#ifndef AUTOCORRELATIONPLUGIN_H
#define AUTOCORRELATIONPLUGIN_H
...
class AutoCorrelationSource : public Kst::BasicPlugin {
  Q_OBJECT
  ...
  protected:
    AutoCorrelationSource(Kst::ObjectStore *store);
    ~AutoCorrelationSource();
